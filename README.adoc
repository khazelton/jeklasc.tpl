...
Hi there with changes, and then some more. The Jekyll AsciiDoc Quickstart project provides a quick way to set up an AsciiDoc-based website using GitHub's publishing infrastructure.
...
You can find a live website created from this repository at https://asciidoctor.github.io/jekyll-asciidoc-quickstart. Hello, new text here.
